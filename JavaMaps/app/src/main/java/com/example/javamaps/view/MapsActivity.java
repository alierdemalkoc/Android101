...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("com.example.javamaps",MODE_PRIVATE);
        info = false;
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if (result){
                    ...
                    Toast.makeText(MapsActivity.this,"İzin vermeniz gerekiyor!",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void delete (View view){ if (selectedPlace != null) {
