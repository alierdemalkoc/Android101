...
import com.alierdemalkoc.artbooktest.databinding.FragmentImageApiBinding
...
class ImageAPI @Inject constructor(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.searchRecycler.adapter = imageRecyclerAdapter
        binding.searchRecycler.layoutManager = GridLayoutManager(requireContext(),3)
